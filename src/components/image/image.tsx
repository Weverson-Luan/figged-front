...
const ImageCustom = ({type, onClickApproved, onClickDisapproved}: ImageProps) => {
...
const onImageClick=(event:any)=> {
    const config:any = {
      ...
      title: () => `Documento da Bobina ${id_bobina}(Aguardando)`,
      hide: () => hide,
    }
    ...
    <Container>
      ...
      <FooterImage>
        <Button
          ...
          weight={600}
          title="Reprovar"
          backgroundColor={type === "aprovado" ? theme.colors.red_300:theme.colors.red_500}
          loading={false}
        />
        ...
        <Button
          ...
          weight={600}
          title="Aprovar"
          backgroundColor={type === "aprovado" ? theme.colors.green_200:theme.colors.green_100}
          loading={false}
        />
      </FooterImage>
    </Container>
