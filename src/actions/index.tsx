...
export const fetchDocumentoAprovar =
  (documento: any, sec_users_id: string) => async (dispatch: any) => {
...
export const fetchDocumentoReprovar =
  (documento: any, formValues: any, sec_users_id: string) =>
  async (dispatch: any) => {
    const resulSecUsersId = await localStorage.getItem("@sec_users_id");
    ...
    if (!resulSecUsersId) {
      ...
      if (formValues.reprovacaoMotivo === "nenhuma") {
        patchData["status_reprovado_mensagem"] =
          formValues.reprovacaoMotivoTexto;
      }
